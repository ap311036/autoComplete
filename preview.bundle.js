...
var Preview = function (_Component) {
    ...
    _createClass(Preview, [{
        key: '_inputOnChangeHandler',
        value: function _inputOnChangeHandler(value) {
            var self = this;
            if (this.timer) {
        ...
        value: function fetchData(value) {
            ...
            fetch(url, {
                ...
                return _this2.processData(d, value);
            }).catch(function (res) {
                return console.error('request has error', res);
            });
        }
    }, {
        key: 'clearWord',
        value: function clearWord(value) {
            this.setState({ selectText: value });
        }
    }, {
        key: 'isFocus',
        value: function isFocus(bool) {
            var show = false;
            if (!this.state.show) {
                show = true;
            }
        ...
        key: 'processData',
        value: function processData(data, searchKeyWord) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_SearchInput2.default, {
                    ...
                    clearWord: function clearWord(value) {
                        return _this3.clearWord(value);
                    },
                    onChange: function onChange(value) {
                        return _this3._inputOnChangeHandler(value);
                    },
                    isFocus: function isFocus(bool) {
                        return _this3.isFocus(bool);
                    }
                }),
                _react2.default.createElement(_index2.default, {
                    ...
                    closeBtnOnClick: function closeBtnOnClick() {
                        return _this3.setState({ show: false });
                    },
                    getItemClickValue: function getItemClickValue(v) {
...
_reactDom2.default.render(_react2.default.createElement(Preview, null), document.getElementById('root'));
...
var _css = __webpack_require__(32);
    ...
    _createClass(Module, [{
        ...
        value: function componentWillUnmount() {
            ...
            window.removeEventListener('keydown', function (e) {
                return _this3.whenKeyPress(e);
            }, true);
        }
    }, {
        key: 'cloneDataArray',
        value: function cloneDataArray() {
            // 複製一個DATA出來操作 不要動到props
            var dataHasDataInedx = JSON.parse(JSON.stringify([].concat(_toConsumableArray(this.props.data)))).sort(function (a, b) {
                return a.txt.length - b.txt.length;
            });
            var newArry = [];
            for (var i = 0; i <= this.props.rules.length - 1; i++) {
                for (var n = 0; n <= dataHasDataInedx.length - 1; n++) {
        ...
        key: 'lightingMatchWord',
        value: function lightingMatchWord(dataArray) {
            // 從複製出來的DATA做搜尋紅字處理
            var searchKeyWord = this.props.matchWord;
            // console.log(searchKeyWord);
            var re = new RegExp('(?:.*| [\(\) \-\s\_]*)(' + searchKeyWord.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, '\\$&') + ')(?:.*| [\(\) \-\s\_]*)', 'i');

            var newData = dataArray.map(function (item) {
                if (re.test(item.txt)) {
                    var searchResult = item.txt.match(re)[1];
        ...
        key: 'getLevel2Groups',
        value: function getLevel2Groups() {
            var levelGroup = new Set();
            this.cloneDataArray().forEach(function (items) {
                levelGroup.add(items.level2);
            });
            return [].concat(_toConsumableArray(levelGroup));
        }
    }, {
        key: '_itemOnClickHandler',
        value: function _itemOnClickHandler(item) {
            this.setState({ select: item.dataIndex });
            this.props.getItemClickValue(item);
        }
    }, {
        key: 'whenKeyPress',
        value: function whenKeyPress(e) {
            if (this.props.isFocus) {
                if (e.keyCode === 40) {
                    var index = this.state.select === null ? 0 : this.state.select + 1;
                ...
                if (e.keyCode === 38) {
                    var prevIndex = this.state.select === null ? this.props.data.length - 1 : this.state.select - 1;
                    if (prevIndex < 0) {
        ...
        value: function render() {
            ...
            var classes = (0, _classnames2.default)('act_rajx', this.props.containerClass, {});
            var getLevel2Groups = this.getLevel2Groups();
            var moduleHtml = _react2.default.createElement(
                'div',
                { className: classes, style: this.props.style },
                this.props.minimumStringQuery && this.props.showText && _react2.default.createElement(
                    'div',
                    { className: 'm-place' },
                    _react2.default.createElement(
                        'button',
                        {
                            onMouseDown: function onMouseDown() {
                                return _this4.props.closeBtnOnClick();
                            },
                            className: 'close'
                        },
                        'x'
                ...
                this.props.minimumStringQuery && this.props.matchWord.length < this.props.minimumStringQueryLength && !this.props.showText && _react2.default.createElement(
                    'div',
                    { className: 'm-place' },
                    _react2.default.createElement(
                        'button',
                ...
                this.props.data.length === 0 && !this.props.showText && this.props.matchWord.length >= this.props.minimumStringQueryLength && _react2.default.createElement(
                    'div',
                ...
                function () {
                    if (getLevel2Groups.length > 0 && _this4.props.matchWord.length >= _this4.props.minimumStringQueryLength && !_this4.props.showText) {
                        return getLevel2Groups.map(function (leve2Items, level2Index) {
                            return _react2.default.createElement(
                                'div',
                                { className: (0, _classnames2.default)('section', _this4.props.sectionClass), key: level2Index },
                                _react2.default.createElement(
                                    'span',
                                    { className: (0, _classnames2.default)('title', _this4.props.titleClass) },
                                    _this4.props.rules.find(function (items) {
                                        return items.title === leve2Items;
                                    }).icon,
                                    leve2Items
                                ),
                                _this4.cloneDataArray().filter(function (items, i) {
                                    return items.level2 === leve2Items;
                                    ...
                                    return _react2.default.createElement('span', {
                                        ...
                                        onClick: function onClick() {
                                            ...
                                            _this4.props.whenSpanClick && _this4.props.whenSpanClick();
                                        }
                                    });
                                })
                            );
                ...
                !this.props.showText && this.props.footer && this.props.matchWord.length >= this.props.minimumStringQueryLength && this.props.data.length > 0 && _react2.default.createElement(
                    'div',
                    { className: 'foot' },
                    '\u641C\u5C0B\u66F4\u591A',
                    '"' + this.props.matchWord + '"',
                    '\u7684\u7522\u54C1'
                )
            );
            if (!this.props.style) {
                ...
                return _ReactDom2.default.createPortal(moduleHtml, document.body);
            }
        }
    }]);
...
*/
var aa=__webpack_require__(6),ba=__webpack_require__(1),m=__webpack_require__(7),p=__webpack_require__(2),v=__webpack_require__(4),da=__webpack_require__(8),ea=__webpack_require__(9),fa=__webpack_require__(10),ha=__webpack_require__(11);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./node_modules/css-loader/index.js??ref--0-1!./node_modules/postcss-loader/lib/index.js??ref--0-2!./node_modules/sass-loader/lib/loader.js!./css.scss", function() {
			var newContent = require("!!./node_modules/css-loader/index.js??ref--0-1!./node_modules/postcss-loader/lib/index.js??ref--0-2!./node_modules/sass-loader/lib/loader.js!./css.scss");
...
var SearchInput = function SearchInput(_ref) {
    var containerClass = _ref.containerClass,
        ...
        clearWord = _ref.clearWord,
        isFocus = _ref.isFocus,
        placeholderText = _ref.placeholderText,
        _ref$onChange = _ref.onChange,
        _onChange = _ref$onChange === undefined ? function () {} : _ref$onChange;
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement('input', {
            ...
            onFocus: function onFocus() {
                return isFocus && isFocus(true);
            },
            onBlur: function onBlur() {
                return isFocus && isFocus(false);
            }
        })
    );
};
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../autoComplete/node_modules/css-loader/index.js??ref--0-1!../autoComplete/node_modules/postcss-loader/lib/index.js??ref--0-2!../autoComplete/node_modules/sass-loader/lib/loader.js!./core.scss", function() {
			var newContent = require("!!../autoComplete/node_modules/css-loader/index.js??ref--0-1!../autoComplete/node_modules/postcss-loader/lib/index.js??ref--0-2!../autoComplete/node_modules/sass-loader/lib/loader.js!./core.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
